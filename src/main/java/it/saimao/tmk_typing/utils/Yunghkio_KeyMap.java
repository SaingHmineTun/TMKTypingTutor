...
public class Yunghkio_KeyMap {
    ...
    private static void initValues() {
        ...
        row1ShiftValues.put("~", "~");
        row1ShiftValues.put("!", "၁");
        row1ShiftValues.put("@", "၂");
        row1ShiftValues.put("#", "၃");
        row1ShiftValues.put("$", "၄");
        row1ShiftValues.put("%", "၅");
        row1ShiftValues.put("^", "၆");
        row1ShiftValues.put("&", "၇");
        row1ShiftValues.put("*", "၈");
        row1ShiftValues.put("(", "၉");
        row1ShiftValues.put(")", "၀");
