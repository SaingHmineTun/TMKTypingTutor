...
public class TMK_KeyMap {
    ...
    private static void initValues() {
        ...
        row1ShiftValues.put("~", "ꧤ");
        row1ShiftValues.put("!", "႑");
        row1ShiftValues.put("@", "႒");
        row1ShiftValues.put("#", "႓");
        row1ShiftValues.put("$", "႔");
        row1ShiftValues.put("%", "႕");
        row1ShiftValues.put("^", "႖");
        row1ShiftValues.put("&", "႗");
        row1ShiftValues.put("*", "႘");
        row1ShiftValues.put("(", "႙");
        row1ShiftValues.put(")", "႐");
        row1ShiftValues.put("_", "(");
        row1ShiftValues.put("+", ")");
        ...
        row2ShiftValues.put("{", "ꧢ");
        row2ShiftValues.put("}", "ꩨ");
        row2ShiftValues.put("|", "ꩩ");
        ...
        row3ShiftValues.put("K", "ို");
        row3ShiftValues.put("L", "ိူ");
