...
public abstract class Perc {
    ...
    public static double p6w() {

        return (gd.getDisplayMode().getWidth() * 6.0) / 100.0;

    }

    public static double p7w() {
        return (gd.getDisplayMode().getWidth() * 7.0) / 100.0;
    }

    public static double p8w() {
        return (gd.getDisplayMode().getWidth() * 8.0) / 100.0;
    }
    ...
    public static double p11w() {

        return (gd.getDisplayMode().getWidth() * 11.0) / 100.0;

    }

    public static double p12w() {

        return (gd.getDisplayMode().getWidth() * 12.0) / 100.0;
    ...
    public static double p1_5h() {
        return (gd.getDisplayMode().getHeight() * 1.5) / 100.0;
    }
    ...
    public static double p7h() {
        ...
        return (gd.getDisplayMode().getHeight() * 7.0) / 100.0;

    }


    public static double p8h() {
        return (gd.getDisplayMode().getHeight() * 8.0) / 100.0;
    }
